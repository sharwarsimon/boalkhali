  ...
  return (
    <div className="space-y-4 pb-12">
      ...
      <div className="bg-white rounded-2xl p-4 sm:p-5 shadow-2xs border border-[#E4E6EB] space-y-3.5">
        ...
        {!isSearching && (
          <div className="bg-gradient-to-r from-red-600 to-rose-600 text-white rounded-xl px-4 py-2.5 sm:py-3 flex items-center justify-between gap-3 shadow-2xs">
            <div className="flex items-center gap-2.5 min-w-0">
              ...
              <div className="flex items-center gap-2 flex-wrap text-xs sm:text-sm">
                ...
                <span className="text-xs text-red-100 hidden sm:inline">• টোল-ফ্রি ২৪ ঘণ্টা পুলিশ, ফায়ার সার্ভিস ও অ্যাম্বুলেন্স</span>
              </div>
            </div>
            <a
              href="tel:999"
              className="px-3.5 py-1.5 bg-white text-red-600 hover:bg-red-50 font-bold text-xs sm:text-sm rounded-lg shadow-2xs flex items-center gap-1.5 cursor-pointer shrink-0 transition-transform active:scale-95"
            >
          ...
          {NUMBERS_SECTIONS.map((section) => (
            <div key={section.id} className="space-y-3">
              ...
              <div className="flex items-center gap-2 px-1">
                <span className="text-orange-500 font-extrabold text-lg tracking-tighter select-none">
                  &gt;&gt;
                </span>
                <h2 className="text-lg sm:text-xl font-black text-[#050505] tracking-tight">
                  {section.title}
                </h2>
              </div>
                ...
                {section.items.map((item) => (
                  ...
                  >
                    ...
                    <div className="space-y-0.5">
                      <h3 className="font-bold text-xs sm:text-sm md:text-base text-[#050505] group-hover:text-[#1877F2] transition-colors leading-tight">
                        {item.title}
                      </h3>
