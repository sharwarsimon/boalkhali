        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-[#65676B]">অভিজ্ঞ ইলেকট্রিশিয়ান, প্লাম্বার, এসি টেকনিশিয়ান, মেকানিক ও মিস্ত্রী সেবা</p>
            </div>
          </div>
                ...
                <div className="p-4 space-y-3">
                  ...
                  <div className="flex items-center gap-1.5 sm:gap-2 pt-1.5">
                    ...
                    <a
                      ...
                      className="flex-1 py-2 px-2.5 sm:px-3 bg-emerald-600 hover:bg-emerald-700 text-white rounded-xl text-xs font-bold flex items-center justify-center gap-1.5 shadow-2xs transition-colors cursor-pointer"
                    ...
                    <a
                      ...
                      className="p-2 sm:px-2.5 sm:py-2 bg-[#1877F2]/10 hover:bg-[#1877F2]/20 text-[#1877F2] rounded-xl text-xs font-bold flex items-center justify-center gap-1 transition-colors cursor-pointer border border-[#1877F2]/20 shrink-0"
                    ...
                    >
                      ...
                      <span className="hidden sm:inline text-[11px]">ফেসবুক</span>
                    </a>
                    ...
                    <button
                      ...
                      className="flex-1 py-2 px-2.5 sm:px-3 bg-[#1877F2] hover:bg-[#166fe5] disabled:bg-blue-300 text-white rounded-xl text-xs font-bold flex items-center justify-center gap-1.5 shadow-2xs transition-colors cursor-pointer"
                    ...
                    <button
                      ...
                      className={`p-2 rounded-xl text-xs font-bold border transition-colors flex items-center justify-center gap-1 cursor-pointer shrink-0 ${
                        isExpanded
