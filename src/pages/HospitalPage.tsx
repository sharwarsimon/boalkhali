...
import { HeartPulse, ArrowLeft, Phone, MapPin, Ambulance, Share2 } from 'lucide-react';
...
export const HospitalPage: React.FC<HospitalPageProps> = ({ navigate }) => {
  ...
  const handleShare = () => {
    if (navigator.share) {
      navigator.share({
        title: 'বোয়ালখালী উপজেলা হাসপাতাল ও স্বাস্থ্যসেবা',
        text: 'বোয়ালখালী উপজেলা স্বাস্থ্য কমপ্লেক্স ও জরুরি স্বাস্থ্য যোগাযোগ নম্বর।',
